...
//1000: LSE clock used as RTC clock source
  uint8_t CLK_RTCSEL0   :1;
  uint8_t CLK_RTCSEL1   :1;
  uint8_t CLK_RTCSEL2   :1;
  uint8_t CLK_RTCSEL3   :1;
...
//111: RTC clock source /128
  uint8_t CLK_RTCDIV0   :1;
  uint8_t CLK_RTCDIV1   :1;
  uint8_t CLK_RTCDIV2   :1;
...
//1: BEEP clock is kept running during Halt mode
  uint8_t CLK_BEEPAHALT   :1;

  uint8_t CLK_Reserved   :1;
...
//////////////////////
typedef struct {
  uint8_t CLK_PCKEN10:1;
  uint8_t CLK_PCKEN11:1;
  uint8_t CLK_PCKEN12:1;
  uint8_t CLK_PCKEN13:1;
  uint8_t CLK_PCKEN14:1;
  uint8_t CLK_PCKEN15:1;
  uint8_t CLK_PCKEN16:1;
  uint8_t CLK_PCKEN17:1;
}CLK_PCKENR1_TYPE;
...
//PCKEN20 ADC1
typedef struct {
  uint8_t CLK_PCKEN20  :1;
  uint8_t CLK_PCKEN21  :1;
  uint8_t CLK_PCKEN22  :1;
  uint8_t CLK_PCKEN23  :1;
  uint8_t CLK_PCKEN24  :1;
  uint8_t CLK_PCKEN25  :1;
  uint8_t CLK_Reserved   :1;
//0: SYSCLK to peripheral disabled
//1: SYSCLK to peripheral enabled
  uint8_t CLK_PCKEN27   :1;
...
//1: LSE oscillator bypassed
   uint8_t CLK_LSEBYP     :1;
   uint8_t CLK_Reserved   :2;
...
//mechanism.
  uint8_t CLK_CSSDGON:1;
  
  uint8_t CLK_Reserved:3;
}CLK_CSSR_TYPE;
...
//The content of these bits is frozen and write protected when BEEPSWBSY is set.
  uint8_t CLK_CLKBEEPSEL0:1;
  uint8_t CLK_CLKBEEPSEL1:1;
...
typedef struct{
  CLK_DIVR_TYPE CLK_DIVR;
  CLK_CRTCR_TYPE CLK_CRTCR;
  CLK_ICKCR_TYPE CLK_ICKR;
  CLK_PCKENR1_TYPE CLK_PCKENR1;
  CLK_PCKENR2_TYPE CLK_PCKENR2;
  CLK_CCOR_TYPE CLK_CCOR;
  CLK_ECKCR_TYPE CLK_ECKR;
  uint8_t CLK_SCSR;
  uint8_t CLK_SWR;
  CLK_SWCR_TYPE CLK_SWCR;
  CLK_CSSR_TYPE CLK_CSSR;
  CLK_CBEEPR_TYPE CLK_CBEEPR;
  uint8_t CLK_HSICALR;
  uint8_t CLK_HSITRIMR;
  uint8_t CLK_HSIUNLCKR;
  CLK_REGCSR_TYPE CLK_REGCSR;
} CLK_TYPE;
