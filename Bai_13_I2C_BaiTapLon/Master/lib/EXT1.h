...
typedef struct{
  ...
  uint8_t EXT1_P0IS:2;       //0,1
  uint8_t EXT1_P1IS:2;       //2,3
  uint8_t EXT1_P2IS:2;       //4,5
  uint8_t EXT1_P3IS:2;       //6,7
...
typedef struct{
  ...
  uint8_t EXT1_P4IS:2;       //0,1
  uint8_t EXT1_P5IS:2;       //2,3
  uint8_t EXT1_P6IS:2;       //4,5
  uint8_t EXT1_P7IS:2;       //6,7
...
typedef struct{
  ...
  uint8_t EXT1_PBIS:2;       //0,1
  uint8_t EXT1_PDIS:2;       //2,3
  uint8_t EXT1_Reserved:4;       //4,5,6,7
...
typedef struct{
  ...
  uint8_t EXT1_P0F:1;        //0
  uint8_t EXT1_P1F:1;        //1
  uint8_t EXT1_P2F:1;        //2
  uint8_t EXT1_P3F:1;        //3
  uint8_t EXT1_P4F:1;        //4
  uint8_t EXT1_P5F:1;        //5
  uint8_t EXT1_P6F:1;        //6
  uint8_t EXT1_P7F:1;        //7
}external_SR1;
//Bits 7:2 Reserved
...
typedef struct{
  ...
  uint8_t EXT1_PBF:1;                //0
  uint8_t EXT1_PDF:1;                //1
  uint8_t EXT1_Reserved:6;           //2,3,4,5,6,7
...
typedef struct{
  ...
  uint8_t EXT1_PBLIS:1;                //0
  uint8_t EXT1_PBHIS:1;                //1
  uint8_t EXT1_PDLIS:1;                //2
  uint8_t EXT1_PDHIS:1;                //3
  uint8_t EXT1_Reserved:4;           //4,5,6,7
